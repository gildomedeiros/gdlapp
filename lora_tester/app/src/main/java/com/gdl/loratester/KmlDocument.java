...
final class KmlDocument {
    ...
    String record(Map<String,Object> values) {
        ...
        if(kind.equals("usb_chunk") || kind.equals("phone_nmea") || kind.equals("phone_gnss_status")) return "";
        ...
        if(kind.equals("usb_error") || kind.equals("usb_disconnected") || kind.equals("usb_connected")
